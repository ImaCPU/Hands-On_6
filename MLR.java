...
public class MLR {
    ...
    public void MatrizX(int registros, int columnas){
        this.tablaX = new double[registros][columnas+1];
        registrosX=0;
    }
    
    public void MatrizY(int registros){
        this.tablaY = new double[registros][1];
    } 
    
    public void NRegistroX(int numero_del_registro){
        for(int i=0; i<=this.tablaX[0].length-1; i++){
            if(i==0){tablaX[numero_del_registro][i]=1;}
            else{
            ...
            tablaX[numero_del_registro][i]=valor;
            }
        }
    }
   
    public void NRegistroY(){
        for(int i=0; i<=this.tablaY.length-1; i++){
            String num = JOptionPane.showInputDialog(null,"Registro "
                    +(i+1)+": "+ "Y=");
            float valor=Float.parseFloat(num);
            tablaY[i][0]=valor;
    ...
    public void DoMLR(){
        ...
        //return "Formula: "+this.producto[0][0]+"+"+this.producto[1][0]+"x1+"+this.producto[2][0]+"x2";
    }
    
    public String getFormula(){
        return "Formula: "+String.format("%.3f",this.producto[0][0])+"+"+String.format("%.3f",this.producto[1][0])
...
//String.format("%.3f",tabla.getFormula())